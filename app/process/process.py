...
def process():
    ...
    block_blob_service.get_blob_to_path(container_name="imageinput", blob_name="test_separator.png", file_path=os.path.join(current_app.config["TEMP_DIR"], "test_separator.png"))
